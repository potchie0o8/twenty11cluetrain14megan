...
!SLIDE incremental transition=fade
<h2>
8.In both internetworked markets and among intranetwored employees, people are
...
information and support from one another than from vendors. So much for corporate
...
!SLIDE incremental transition=fade
<h2>
14.Corporation do not speak in the same voice as these new networked conversations. To their
intended online audiences, companies sound hollow, flat, literally inhuman.

!SLIDE incremental transition=fade
<h2>
15.In just a few more years, the content homogenized "voice" of business-the sound of mission
statements and brochure-will seem as contrived and artificial as the language of the 18th century
French court.
...
televi-sion are kidding themselves.
...
!SLIDE bullets incremental transition=fade
<h2>
33.Learning to speak with human voice is not a parlor trick. It can't be "picked up" at some tony conference.

!SLIDE bullets incremental transition=fade
<h2>
34. To speak with human voice, companies must share the concerns on their communities.
...
!SLIDE bullets incremental transition=fade
<h2>
39.The community of disco-urse is the market.
...
!SLIDE bullets incremental transition=fade
<h2>
46.A health intranet organizeds workers in many meanings of the word. Its effect is more radicals than the agenda of any union.
...
!SLIDE bullets incremental transition=fade
<h2>
48.When corporate intranets are not constrained by fear ang legalistic rules, the type of conversation they encourage sounds remarkably like the conversation of the networked marketplace.

!SLIDE bullets incremental transition=fade
<h2>
49.Org charts worked in an older economy where plans could be fully understood from atop steep management pyramids and detailed work order could be handed down from on high.
...
!SLIDE bullets incremental transition=fade
<h2>
51.Command-and-control management style both derive from and reinforce bureaucracy, power tripping and an overall culture of paranoia.
...
!SLIDE bullets incremental transition=fade
<h2>
53.There are two conversation going on. One inside the company. One with the market.

!SLIDE bullets incremental transition=fade
<h2>
54.In the most cases, neither conversation is going very well. Almost invariably, the cause of failure can be traced to obsolete notions of command and control.
...
!SLIDE bullets incremental transition=fade
<h2>
71. Your tired notions of "the market" make our eyes glaze over. We don't recignize ourselves in your projections-perhaps because we know we're already elsewhere.
...
!SLIDE bullets incremental transition=fade
<h2>
84. We know some people from our company. They're pretty cool online. Do you have any more like that you're hiding? Can they come out and play?
...
!SLIDE bullets incremental transition=fade
<h2>
91. Our allegiance is to ourselves-our friends, our new allies and acquiantances, even our sparring partners. Companies that have no part in this world, also have no future.
